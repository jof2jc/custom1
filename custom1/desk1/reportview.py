...
from frappe.utils import nowdate, nowtime, now_datetime, flt, cstr, formatdate, get_datetime, add_days, getdate, get_time, get_user_format
...
def export_query():
	...
	if not form_params["last_efaktur_no"]:
		return

	last_efaktur_no = form_params["last_efaktur_no"]
	efaktur_no = "0000000000000"

	del form_params["doctype"]
	del form_params["file_format_type"]
	del form_params["last_efaktur_no"]
	...
	data1 = [['FK','KD_JENIS_TRANSAKSI','FG_PENGGANTI','NOMOR_FAKTUR','MASA PAJAK','TAHUN PAJAK','TANGGAL_FAKTUR','NPWP','NAMA','ALAMAT LENGKAP',  
	...
	if file_format_type == "CSV":
		...
		xlsx_file = make_xlsx(data1, doctype)
