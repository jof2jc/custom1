...
def execute(filters=None):
	...
	for d in item_list:
		...
		row = [d.item_code,  
			d.qty, d.base_net_rate, d.base_net_amount,
			d.item_name, d.item_group,
...
def get_conditions(filters):
	...
	for opts in (("company", " and company=%(company)s"),
		...
		("territory", " and si.territory = %(territory)s"),
...
def get_tax_accounts(item_list, columns):
	...
	columns += ["Total Tax:Currency/currency:80", "Total:Currency/currency:80", "Total Per Item:Currency/currency:80"]
